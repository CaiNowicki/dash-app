...
from pages import index, predictions, process, visualizations

# Navbar docs: https://dash-bootstrap-components.opensource.faculty.ai/l/components/navbar
navbar = dbc.NavbarSimple(
    brand='What Region is Your Food From? Thanksgiving Edition',
    brand_href='/', 
    children=[
        dbc.NavItem(dcc.Link('Predictions', href='/predictions', className='nav-link')),
        dbc.NavItem(dcc.Link('Process', href='/process', className='nav-link')),
        dbc.NavItem(dcc.Link('Visualizations', href='/process', className='nav-link')),
    ],
    sticky='top',
    color='light', 
    light=True, 
        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/dunkelweizen'), 
